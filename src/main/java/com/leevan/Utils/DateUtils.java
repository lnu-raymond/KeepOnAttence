...
//        SimpleDateFormat format = new SimpleDateFormat();
        String beginTime = "2023-04-12 09:30:01";
        String endTime =   "2023-04-12 10:47:02";


//        long subtraction = dateSubtraction(beginTime, endTime);

        Float hour = dateSubtractionTransferHours(beginTime, endTime);
//        hour = Float.valueOf(String.format("%.2f", hour));
        System.out.println(hour);
//        获取两个时间之间相差了多少个小时
//        Long hour =  subtraction % nd /nh;
//        System.out.println(hour);
//        获取两个小时之间相差了多少分钟
//        long min = subtraction % nd % nh /nm;
//        System.out.println("相差了多少分钟:"+min);
//        float minus_of_hour = (float) min/60;
//        System.out.println("分钟占小时的多少比例按照百分制计算："+minus_of_hour);
//        boolean isBelongTimeZone = CurrentTimeIsBelongTimeZone("2023-04-12 09:30", "08:30", "12:00");
//        System.out.println(isBelongTimeZone);
